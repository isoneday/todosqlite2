...
import com.training.todosqlite.AddOrEditActivity

import com.training.todosqlite.R


import com.training.todosqlite.models.Tasks
import java.util.*
...
class TaskRecyclerAdapter(tasksList: List<Tasks>, internal var context: Context) : RecyclerView.Adapter<TaskRecyclerAdapter.TaskViewHolder>() {
    ...
    inner class TaskViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        var desc: TextView = view.findViewById<TextView>(R.id.tvDesc)
        var list_item: LinearLayout = view.findViewById<LinearLayout>(R.id.list_item)
    }
